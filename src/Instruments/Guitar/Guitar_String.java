...
//Has to be of Runnable interface to be run on a separate thread
...
/*Class constructor which takes frequency as input*/

	public Guitar_String(int freq)		
	{
		fs = (d+1) * freq /2;		/*The algorithm will produce a note at 2*freq/(d+1) */
	}
/*Writes the note to the line for given time in ms*/
...
/*Creates random byte array*/
	...
	/*The main algorithm where the standing wave is generated, it is also possible to extend to get better sound*/
